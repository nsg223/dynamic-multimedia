$(document).ready(function() {
    ...
    function log_size(photo_id) {

        request_url = 'https://api.flickr.com/services/rest/?method=flickr.photos.getSizes&api_key=bd34833c1dc13ee8d364413c483f18dc&photo_id='+ photo_id +'&format=json&nojsoncallback=1';
        $.getJSON(request_url, function(data) {
            console.log(data);
        });
